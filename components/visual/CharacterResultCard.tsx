...
export function CharacterResultCard({ match, rank, expanded = false }: { match: CharacterMatch; rank: number; expanded?: boolean }) {
  ...
  return (
    <div
      className="w-full rounded-md p-4 mb-3"
    ...
    >
      <div className="flex items-center gap-4">
        <span className="f-14 fw-700" style={{ color: "#C9A24B", minWidth: 44 }}>{match.similarity}%</span>
        ...
        {rank === 1 && <span className="f-10 txt-upp" style={{ color: "#C9A24B", letterSpacing: "0.15em" }}>Top Match</span>}
      </div>

      {expanded && (
        <div className="mt-4 text-left">
          <p className="f-10 txt-upp mb-1" style={{ color: "#C9A24B", letterSpacing: "0.15em" }}>Why you resemble this design</p>
